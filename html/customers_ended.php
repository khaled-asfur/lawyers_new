...
<html>
    ...
    <body dir="rtl">
            ...
            <div class="container text-center">
                <div class="row">
                    <form class="form-search"  autocomplete="on" METHOD ="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <input type="text" placeholder="ادخل رقم الهوية او اسم العميل" name="name_or_id" autocomplete="on"/>
        ...
        <section class="sec-table">
            <div class="container">
                <table class="table-section table-bordered table-condensed table-hover" id="my_table">
